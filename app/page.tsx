...
const milestones = [
  ...
  },
  {
    ...
    company: 'Sicily Labs — Founded',
    description: 'All the hustle, all the lessons, all the late nights — poured into one studio. Sicily Labs is not a job, it\'s the mission. We are just getting started.',
    cx: 792,
    cy: 40,
  },
];
